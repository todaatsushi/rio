...
function M.setup()
    ...
    local highlights = {
        ...
        -- Oil
        OilDir = { fg = colors.gold, bg = colors.background, italic = true },
        OilCopy = { fg = colors.soft_pink, bg = colors.background, italic = true, bold = true },
        OilMove = { fg = colors.soft_pink, bg = colors.background, italic = true, bold = true },
        OilPurge = { fg = colors.gold, bg = colors.background, italic = true, bold = true },
        OilTrash = { fg = colors.gold, bg = colors.background, italic = true, bold = true },
        OilChange = { fg = colors.soft_pink, bg = colors.background, italic = true, bold = true },
        OilCreate = { fg = colors.soft_pink, bg = colors.background, italic = true, bold = true },
        OilDelete = { fg = colors.soft_pink, bg = colors.background, italic = true},
        OilHidden = { fg = colors.red_pink, bg = colors.background, italic = true},
        OilSocket = { fg = colors.gold, bg = colors.background, italic = true},
        OilDirIcon = { fg = colors.gold, bg = colors.background, italic = true},
        OilRestore = { fg = colors.gold, bg = colors.background, italic = true},
        OilDirHidden = { fg = colors.gold, bg = colors.background, italic = true},
        OilFileHidden = { fg = colors.gold, bg = colors.background, italic = true},
        OilLinkHidden = { fg = colors.gold, bg = colors.background, italic = true},
        OilLinkTarget = { fg = colors.gold, bg = colors.background, italic = true},
        OilSocketHidden = { fg = colors.gold, bg = colors.background, italic = true},
        OilTrashSourcePath = { fg = colors.gold, bg = colors.background, italic = true},
        OilLinkTargetHidden = { fg = colors.gold, bg = colors.background, italic = true},
        OilOrphanLinkHidden = { fg = colors.gold, bg = colors.background, italic = true},
        OilOrphanLinkTarget = { fg = colors.gold, bg = colors.background, italic = true},
        OilOrphanLinkTargetHidden = { fg = colors.gold, bg = colors.background, italic = true}
    }
